...
GOOGLE_CSE_QUERY_KEYWORDS = "(행사기획 OR 이벤트기획 OR 콘텐츠기획 OR 경영지원 매니저) 채용"
...
# '개인' 프로젝트의 이력서·경력기술서·포트폴리오 자료에 있는 실제 경력만 근거로 함.
...
RESUME_PROFILE = [
    {
        "category": "행사·공연·전시·MICE 기획운영",
        "keywords": ["행사", "이벤트", "전시", "공연", "축제", "컨벤션", "mice", "btl", "큐레이터", "박람회"],
        "highlights": [
            "주식회사 엑스포럼 재직 중(2026.08~, 직원/계약직) - 서울팝콘(코엑스 A홀 개최, Seoul POPCON) 스폰서·부스 제안서 작성 및 이벤트 프로그램 기획(넥슨·크런치롤·로커스스튜디오 등 IP 보유사 대상)",
            "서울 라이브아이돌 페스티벌 1·2회 무대 기획 및 국내외 아티스트 섭외(최대 20팀)",
            "코믹월드 SUMMER 2024 스트리머존 기획·운영(스트리머 23명 참여, MCN 협업)",
            "오프라인 행사(코믹월드, 연 10회) 매출매입 관리 및 정산 실무",
        ],
    },
    {
        "category": "웹툰·웹소설 기획/편집/PD",
        "keywords": ["웹툰", "웹소설", "장르물", "판타지", "로맨스", "무협", "bl"],
        "highlights": [
            "북팔코믹스 콘텐츠2팀 PD(2018.11~2021.08) - 웹소설 기획·연재 관리, 교정 프로세스 개선(효율 400%↑)",
            "웹툰 작품별 매출 데이터 관리 경험(코믹월드&레드피치스튜디오)",
            "다양한 작가·외주사 커뮤니케이션 경험",
        ],
    },
    {
        "category": "콘텐츠 기획·PM·매거진 에디터",
        "keywords": ["콘텐츠기획", "콘텐츠 기획", "매거진", "에디터", "pm", "프로젝트매니저", "프로젝트 매니저"],
        "highlights": [
            "더블디스튜디오 매거진(비애티튜드) 인터뷰 콘텐츠 PM",
            "기아자동차 밀라노 디자인위크 연설 스크립트 제작 PM",
            "SNS 콘텐츠 기획 경험(코믹월드&레드피치스튜디오)",
        ],
    },
    {
        "category": "영상·숏폼 콘텐츠 제작 PD",
        "keywords": ["영상", "숏폼", "크리에이터", "콘텐츠제작", "콘텐츠 제작", "pd"],
        "highlights": [
            "코믹월드 스트리머존 기획·운영(MCN 협업) - 영상/SNS 콘텐츠 기획 경험",
            "Premiere Pro / DaVinci Resolve 중급 활용 가능",
            "더블디스튜디오 매거진 인터뷰 콘텐츠 PM 경험",
        ],
    },
    {
        "category": "경영지원·경영관리·총무",
        "keywords": ["경영지원", "경영관리", "총무", "행정", "인사"],
        "highlights": [
            "정부 R&D 사업비 증빙 및 연구비 처리(빌리어네어즈)",
            "사내 복리후생 기획·운영 및 사내 운영지원",
            "입점 브랜드 매출 1위 달성(더블디스튜디오 온라인샵 운영지원·작가 정산·입점 브랜드 관리)",
        ],
    },
]
